...
export default function Login(): React.ReactElement {
    ...
    const [signupErrors, setSignupErrors] = useState({ detail: "", email: "", password: "", name: "" });
    ...
    const [loginErrors, setLoginErrors] = useState({ detail: "", email: "", password: "" });

    function handleSignupFormChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    async function submitLoginForm() {
        return axios
            ...
            .then((response) => {
                setLoginErrors({ detail: "", email: "", password: "" });
    ...
    async function submitSignupForm() {
        return axios
            ...
            .then((_) => {
                axios
                    .post("/token", { email: signupForm.email, password: signupForm.password })
                    .then((response) => {
                        setSignupErrors({ detail: "", email: "", password: "", name: "" });
                        localStorage.setItem("accessToken", response.data.access);
                        if (signupForm.remember_me) {
                            localStorage.setItem("refreshToken", response.data.refresh);
                        }
                        navigate("/dashboard");
                    })
        ...
        <div className="h-full flex flex-row justify-evenly">
                        ...
                        <div className="flex flex-col items-center justify-center h-full p-4 mx-auto">
                            <div className="w-full bg-base-200 rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 border-primary">
                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    <h1 className="text-xl font-bold leading-tight tracking-tight md:text-2xl text-center">Create a new account</h1>
                                    <div className="space-y-4 flex flex-col gap-0">
                                        <InputField name="email" label="Email" type="text" placeholder="" error={signupErrors?.email} value={signupForm.email} onChange={handleSignupFormChange} />
                                        <InputField name="name" label="Name" type="text" placeholder="" error={signupErrors?.name} value={signupForm.name} onChange={handleSignupFormChange} />
                                        <InputField name="password" label="Password" type="password" placeholder="" error={signupErrors?.password} value={signupForm.password} onChange={handleSignupFormChange} />
                                        {signupErrors?.detail && <p className="text-error text-sm text-center">{signupErrors.detail}</p>}
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-start">
                                                <div className="form-control">
                                                    <label className="label cursor-pointer gap-2">
                                                        <input type="checkbox" name="remember_me" checked={signupForm.remember_me} onChange={(e) => setSignupForm({ ...signupForm, [e.target.name]: e.target.checked })} className="checkbox" />
                                                        <span className="label-text">Remember me for 1 month</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <SubmitButton label="Signup" onClick={submitSignupForm} />
                                        <p className="text-sm">
                                            Already have an account ?{" "}
                                            <button onClick={() => setActiveTab("login")} className="font-medium link">
                                                Login
                                            </button>
                                        </p>
                                    </div>
            ...
            <div className="hidden md:block w-full h-full bg-primary text-primary-content">
                <div className="text-start flex flex-col justify-evenly h-full p-6">
                    <div>
                        <h1 className="mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-5xl">Visualize data like never before</h1>
                        <p className="mb-6 font-semibold lg:mb-8 md:text-lg lg:text-xl">
                            With Dash Manager, you can create, customize and share beautiful dashboards in minutes. Login now to get started.
                        </p>
                    </div>
                    <svg
                        version="1.1"
                    ...
                    >
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g>
                                ...
                                <path
                                    style={{ fill: "#936B49" }}
                                    d="M168.328,489.215c0,2.365-1.917,4.282-4.282,4.282h-14.484c-2.365,0-4.282-1.917-4.282-4.282 l62.899-293.461c0-2.365,1.917-4.282,4.282-4.282h14.484c2.365,0,4.282,1.917,4.282,4.282L168.328,489.215z"
                                />{" "}
                                <path
                                    style={{ fill: "#936B49" }}
                                    d="M343.65,489.215c0,2.365,1.917,4.282,4.282,4.282h14.484c2.365,0,4.282-1.917,4.282-4.282 l-62.896-293.458c0-2.365-1.92-4.282-4.282-4.282h-14.484c-2.365,0-4.282,1.917-4.282,4.282L343.65,489.215z"
                                />{" "}
                            </g>{" "}
                            <path
                                style={{ fill: "#6B4F37" }}
                                d="M350.339,330.269c0,3.751-3.042,6.791-6.794,6.791H168.433c-3.751,0-6.791-3.042-6.791-6.791v-13.836 c0-3.751,3.042-6.794,6.791-6.794h175.112c3.751,0,6.794,3.042,6.794,6.794V330.269z"
                            />{" "}
                            <path
                                style={{ fill: "#936B49" }}
                                d="M267.513,489.215c0,2.365-1.917,4.282-4.282,4.282h-14.484c-2.365,0-4.282-1.917-4.282-4.282V195.757 c0-2.365,1.92-4.282,4.282-4.282h14.484c2.365,0,4.282,1.917,4.282,4.282V489.215z"
                            />{" "}
                            <rect
                                x="56.483"
                                style={{ fill: "#6B4F37" }}
                        ...
                        <div className="flex flex-col items-center justify-center h-full p-4 mx-auto">
                            <div className="w-full bg-base-200 rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 border-primary">
                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    ...
                                    <div className="space-y-4 flex flex-col gap-0">
                                        <InputField name="email" label="Email" type="text" placeholder="" error={loginErrors?.email} value={loginForm.email} onChange={handleLoginFormChange} />
                                        <InputField name="password" label="Password" type="password" placeholder="" error={loginErrors?.password} value={loginForm.password} onChange={handleLoginFormChange} />
                                        {loginErrors?.detail && <p className="text-error text-sm text-center">{loginErrors.detail}</p>}
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-start">
                                                <div className="form-control">
                                                    <label className="label cursor-pointer gap-2">
                                        ...
                                        <p className="text-sm">
                                            ...
                                            <button onClick={() => setActiveTab("signup")} className="font-medium link">
                                                Sign up
                                            </button>
                                        </p>
                                    </div>
